...
var createStore = (function (_ref) {
  ...
  return redux.createStore(reducer, composeEnhancers(redux.applyMiddleware(style(styleMarshal), dimensionMarshalStopper(getDimensionMarshal), lift$1(getDimensionMarshal), drop$1, dropAnimationFinish, pendingDrop, autoScroll(getScroller), responders(getResponders, announce))));
});
...
var DragDropContext = function (_React$PureComponent) {
  ...
  function DragDropContext(props, context) {
    ...
    _this.scrollContainer = function (change) {
      var state = _this.store.getState();
      ...
      var draggableRef = _this.getDraggableRef();
    ...
    _this.notifyScrollToWindow = function (e) {
      var state = _this.store.getState();
      ...
      _this.store.dispatch(moveByWindowScroll({
        newScroll: getContainerScroll(_this.ref)
      }));
    };
    ...
    _this.setRef = function (ref) {
      ...
      if (_this.ref) {
        _this.ref.removeEventListener('scroll', _this.notifyScrollToWindow);
      }

      _this.ref = ref;

      if (_this.ref) {
        _this.ref.addEventListener('scroll', _this.notifyScrollToWindow);
      }
    ...
    _this.dimensionMarshal = createDimensionMarshal(callbacks, {
      getContainer: _this.getDraggableRef
    });
    _this.autoScroller = createAutoScroller(_extends({
      scrollWindow: _this.scrollContainer,
...
var DroppableDimensionPublisher = function (_React$Component) {
  ...
  function DroppableDimensionPublisher(props, context) {
    ...
    _this.getDimensionAndWatchScroll = function (windowScroll, options) {
      ...
      if (env.closestScrollable && !ReactDOM.findDOMNode(_assertThisInitialized(_this)).contains(env.closestScrollable)) {
        env = _extends({}, env, {
...
var Droppable = function (_React$PureComponent) {
  _inheritsLoose(Droppable, _React$PureComponent);
...
var Draggable = function (_React$PureComponent) {
  _inheritsLoose(Draggable, _React$PureComponent);
  ...
  function Draggable(props, context) {
    ...
    _this.renderChildren = function (dragHandleProps) {
      ...
      var provided = _this.getProvided(mapped, dragHandleProps);

      var snapshot = mapped.snapshot;
